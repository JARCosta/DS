...
plot_multiline_chart(
    ...
    title=f"MLP overfitting study for lr_type={lr_type} and lr=https://colab.research.google.com/drive/1X6HdZ5VPZ_VX9dlY5TMXaS6Eh9OP6SN1#scrollTo=x0cZROKnT0I4{lr}",
